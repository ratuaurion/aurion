...
const EXPECTED_SENDER_HEX: &str = "cb095697ccc5acbf23e176ee4f05e7e77ddfe54236bfe8c8b42e78c3d5a95aad";
...
const EXPECTED_PREIMAGE_HASH: &str = "807fa6f843afc7e23cbc927aaf2d86556d05ca9690a304d8e2c1a293430fb7ff";
...
const EXPECTED_BLOCKHASH_HEX: &str = "eed74fb70c5cf061b51688acc25f7f08d3445d08e4b40a0c24eccefa56024701";
...
fn golden_transaction_preimage_is_stable_across_wallet_and_validator() {
    ...
    assert_eq!(preimage.len(), 12 + 1 + 2 + 4 + 1 + 1 + 32 + 32 + 8 + 16 + 16 + 8 + 4);
}
