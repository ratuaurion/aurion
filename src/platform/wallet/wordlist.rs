//! Daftar Kata Kanonikal BIP-39 (BIP-0039 English Wordlist - 2048 Kata).
//! Mematuhi Standar Industri BIP-39 untuk Pembuatan Frase Pemulihan 24 Kata.
...
pub static BIP39_WORDLIST: [&str; 2048] = [
    ...
    "romance", "roof", "rookie", "room", "rose", "rotate", "rough", "round", "route", "row",
    ...
    "taxi", "teach", "team", "tell", "ten", "tenant", "tennis", "term", "test", "text",
    ...
    "usual", "utility", "vacant", "vacuum", "vague", "valuable", "valet", "valley", "valve", "van",
